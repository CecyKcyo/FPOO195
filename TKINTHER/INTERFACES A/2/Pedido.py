...
billetes_image = load_image("C:/Users/Danie/Documents/UPQ/CUATRIMESTRE 3/VS estudio/2/Billetes.png", 40, 40)
billetes_label = ttk.Label(main_frame, image=billetes_image)
billetes_label.grid(row=8, column=1, padx=5, pady=5)

tarjetas_image = load_image("C:/Users/Danie/Documents/UPQ/CUATRIMESTRE 3/VS estudio/2/Tarjeta.png", 40, 40)
tarjetas_label = ttk.Label(main_frame, image=tarjetas_image)
tarjetas_label.grid(row=8, column=2, padx=5, pady=5)

# Botón Agregar
plus_image = load_image("C:/Users/Danie/Documents/UPQ/CUATRIMESTRE 3/VS estudio/2/plus.png", 40, 40)
